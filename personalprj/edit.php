  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Engine" name="Engine" value="<?php echo  $user_data['Engine'] ?>">
          <label for="floatingInput">Engine</label>
        </div>

        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Gas_power" name="Gas_power" value="<?php echo  $user_data['Gas_power'] ?>">
          <label for="floatingInput">Gas_power</label>
        </div>

        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Gear" name="Gear" value="<?php echo  $user_data['Gear'] ?>">
          <label for="floatingInput">Gear</label>
        </div>

        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Hp" name="Hp" value="<?php echo  $user_data['Hp'] ?>">
