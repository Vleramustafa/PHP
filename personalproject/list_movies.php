        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php foreach ($users_data as $user_data) { ?>
                ...
                <td><?php echo $user_data['gymEquipment_name']; ?></td>
                <td><?php echo $user_data['gymEquipment_desc']; ?></td>
                <td><?php echo $user_data['gymEquipment_rating']; ?></td>
                <td><?php echo $user_data['gymEquipment_image']; ?></td>
