...
if($_SESSION['is_admin']=='true'){
    $sql="SELECT clothes.clothes_name,users.email,orders.id,bookings.nr_tickets,bookings.date,bookings.is_approved,bookings.time FROM movies
    INNER JOIN orders ON clothes.id=orders.clothes_id 
    INNER JOIN users ON user.id=orders.user_id";
    ...
    $sql="SELECT clothes.movie_name,users.email,bookings.id,bookings.nr_tickets,bookings.date,bookings.is_approved,bookings.time FROM movies
