...
if($_SESSION['is_admin']=='true'){
    $sql="SELECT movies.movie_name,users.email,bookings.id,bookings.nr_tickets,booking.date,booking.is_approved,bookings.time FROM movies INNER JOIN bookings ON movies.id=boolings.movie.id INNER JOIN users ON users.id=bookings.user_id";
    ...
    $sql="SELECT movies.movie_name,users.email,bookings.id,bookings.nr_tickets,booking.date,booking.is_approved,bookings.time FROM movies INNER JOIN bookings ON movies.id=boolings.movie.id INNER JOIN users ON users.id=bookings.user_id WHERE bookings,user_id=:user_id";
