...
if($_SESSION['is_admin']=='true'){
    $sql="SELECT movies.move_name,users.email,bookings.id,bookings.nr_tickets,bookings.date,bookings.is_approved,bookings.time FROM movies
    ...
    $sql="SELECT movies.move_name,users.email,bookings.id,bookings.nr_tickets,bookings.date,bookings.is_approved,bookings.time FROM movies
    INNER JOIN bookings ON movies.id=bookings.movie_id
    INNER JOIN users ON users.id=bookings.users_id WHERE bookings,user_id=:user_id";

    $selectBookings=$conn->prepare(':user_id',$user_id);
    $selectBookings->execute();
    $bookings_data=$selectBookings->fetchAll();
}
