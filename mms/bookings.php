...
if($_SESSION['is_admin']=='true'){
    $sql="SELECT movies.movie_name,users.email,bookings.id,booking.nr_ticket,bookings.date,bookings.is_approved,bookings.time FROM movies
    INNER JOIN bookings ON movies.id=bookings.movies_id
