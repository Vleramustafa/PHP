...
if($_SESSION['is_admin']=='true'){
    $sql="SELECT movies.movie_name,user,email,bookings.id,bookings.nr_tickets,bookings.data,bookingsis_approved,Bookings.time FROM movies
    INNER JOIN booikings ON movies.id=bookings.movie_id
