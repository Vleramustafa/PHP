...
if(isset($_POST['submit'])){
    ...
    $movie_iamge=$_POST['movie_image'];

    $sql="INSERT INTO movies(movie_name,movie_desc,movie_quality,movie_rating,movie_iamge) VALUES (:movie_name,:movie_desc,:movie_quality,:movie_rating,:movie_iamge)";
