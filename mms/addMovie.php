...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO movie(movie_name,movie_desc,movie_quality,movie_image,movie_rating) VALUES (movie_name,movie_desc,movie_quality,movie_image,movie_rating)";
