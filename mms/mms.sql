...
CREATE TABLE bookings(
    ...
    is_appeoved varchar(255) NOT NULL,
    time varchar(255) NOT NULL
    
)

ALTER TABLE usres ADD PRIMARY KEY (id);
ALTER TABLE movies ADD PRIMARY KEY (id);
ALTER TABLE bookings ADD PRIMARY KEY (id);

ALTER TABLE users MODIFY id int(1) NOT NULL AUTO_INCREMENT
ALTER TABLE movies MODIFY id int(1) NOT NULL AUTO_INCREMENT;
ALTER TABLE bookings MODIFY id int(1) NOT NULL AUTO_INCREMENT;
